...
const oldMuni = `function renderMunicipios() {
...
const newMuni = \`function renderMunicipios() {
      var box = $("#muniGrid"); if (!box) return;
      populateMuniDept();
      var q = norm($("#muniSearch") ? $("#muniSearch").value : "");
      var dep = $("#muniDept") ? $("#muniDept").value : "";
...
appjs = appjs.replace(oldMuni, newMuni);
fs.writeFileSync("assets/js/app.js", appjs);
console.log("Replaced renderMunicipios");
