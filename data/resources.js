...
window.CRC_DATA = {
  meta: {
    ...
    contactEmail: "centralderecursos@andanzascentrocultural.com", // cambiado al canal real
    earthquake: {
      date: "2026-08-10",
      magnitude: "7.4",
  ...
  situation: [
    ...
    { id: "choco-epicentro", title: "Chocó: Epicentro y Zona Cero", metric: "Afectación Crítica", summary: "San José del Palmar, Nóvita y Quibdó presentan colapso total de servicios. Vías bloqueadas hacia el Pacífico. Rescate en curso.", region: "Chocó", severity: "critical", source_name: "UNGRD", url: "https://portal.gestiondelriesgo.gov.co/", as_of: "2026-08-15" },
    { id: "risaralda-afectaciones", title: "Risaralda: Colapsos y Acopios", metric: "Alta concentración", summary: "Daños severos en Pereira y Dosquebradas. Hospitales operando al 100% de capacidad. 7 centros de acopio habilitados.", region: "Risaralda", severity: "critical", source_name: "Alcaldía de Pereira", url: "https://www.pereira.gov.co/", as_of: "2026-08-15" },
    { id: "caldas-vias", title: "Caldas: Deslizamientos y Vías", metric: "Movilidad restringida", summary: "Manizales y Chinchiná reportan daños en viviendas. Deslizamientos mantienen vías intermunicipales del sur cerradas.", region: "Caldas", severity: "warning", source_name: "Gobernación de Caldas", url: "https://caldas.gov.co/", as_of: "2026-08-14" },
    { id: "quindio-armenia", title: "Quindío: Alerta en Armenia", metric: "Daños estructurales", summary: "Colapso de 4 edificaciones antiguas en Armenia y daños en La Tebaida. Se mantiene la alerta máxima por réplicas fuertes.", region: "Quindío", severity: "warning", source_name: "Asocapitales", url: "https://www.asocapitales.co/terremoto-colombia.html", as_of: "2026-08-14" },
    { id: "antioquia-suroeste", title: "Antioquia: Suroeste afectado", metric: "Vías bloqueadas", summary: "Afectaciones en Ciudad Bolívar y Andes. Cierre preventivo de la vía al mar por riesgo de desprendimiento de rocas.", region: "Antioquia", severity: "warning", source_name: "Dapard Antioquia", url: "https://dagran.antioquia.gov.co/", as_of: "2026-08-15" },
    { id: "cauca-norte", title: "Cauca: Norte sin energía", metric: "Servicios suspendidos", summary: "Daños moderados en Santander de Quilichao y Puerto Tejada. Interrupciones prolongadas de energía y acueducto rural.", region: "Cauca", severity: "warning", source_name: "Gobernación del Cauca", url: "https://www.cauca.gov.co/", as_of: "2026-08-15" },
  ],
